...
namespace SchoolToHomeBehaviorTracking_Client
{
    ...
    public partial class ListForms : INotifyPropertyChanged
    {
        ...
        static ChannelFactory<IMetaInterface> teacherChannelFactory = new
        ChannelFactory<IMetaInterface>("SchoolToHomeServiceEndpoint");

        static IMetaInterface proxy = teacherChannelFactory.CreateChannel();
        ...
        public void RefreshTeacherFormsList()
        {
            ...
            List<string> list = proxy.GetAllTeacherForms(BEHAVIOR_CATEGORY);
            ...
            list = proxy.GetAllTeacherForms(OTHER_CATEGORY);
        ...
        public void RefreshStudentForms()
        {
            ...
            if (_studentName != null)
            {
                ...
                List<string> list = proxy.GetStudentFormsByCategory(fname, lname, BEHAVIOR_CATEGORY);
                _forms.CollectionChanged += List_Changed;
                ...
                list = proxy.GetStudentFormsByCategory(fname, lname, OTHER_CATEGORY);
                _otherForms.CollectionChanged += List_Changed;
